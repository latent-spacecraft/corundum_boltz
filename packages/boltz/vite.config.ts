...
// The "bring your own SMILES" preprocessing now runs fully in-browser via the
// @corundum/rdkit WASM op (get_boltz_blob); the old dev-only /__smiles_to_blob
// endpoint (which shelled out to scripts/python/smiles_to_blob.py) is retired.
// scripts/python/ is kept as the reference impl + validation harness.
